...
function ListingForm(props) {
    ...
    const initialdata = props.type === 'create' ? { 
        imageUrls: [],
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(false)
            setLoading(true)
            const targetUrl = props.type === 'create' ? `/api/listing/create`: `/api/listing/update/${formData._id}`;
    ...
    return (
        <div className="max-w-5xl mx-auto px-3 my-8">
            <h1 className='text-3xl font-semibold my-8 text-center capitalize'>{props.type} Listing Page</h1>
